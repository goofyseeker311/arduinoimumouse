...
#define grav 9.82f
#define bufs 4
#define movelim 0.05f
#define liftlim 0.05f
...
void loop() {
  ...
  if (IMU.accelerationAvailable()) {
      ...
      sprintf(buffer,"%lu: mousemove mousedx: %d, mousedy: %d, mousex: %d, mousey: %d",cstime,(int)(mousedx*1000000.0f),(int)(mousedy*1000000.0f),(int)(mousex*1000000.0f),(int)(mousey*1000000.0f));
